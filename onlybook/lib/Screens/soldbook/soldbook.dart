...
class SoldBook extends StatefulWidget {
  final Books book;
  SoldBook(this.book);

  @override
  State<SoldBook> createState() => _SoldBookState();
}

class _SoldBookState extends State<SoldBook> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //       onTap: () async {
      //         final collection =
      //             FirebaseFirestore.instance.collection('books3');
      //         await collection
